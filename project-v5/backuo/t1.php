...
END;
    if($result->super_user == 1){
        $_SESSION['super_user'] = $result['super_user'];
        $body .= <<<END
    <h1 style="text-align: center;">logged in as super user</h1>
END;
    } else{
        $body .= <<<END
    <h1 style="text-align: center;">logged in as normal user</h1>
END;
    }
  } else {
    $body .= <<<END
    <h1 style="text-align: center;">Wrong username or password. Try again</h1>
END;
  }
}
